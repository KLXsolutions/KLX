    ...
    <section id="about" style={{ padding:'96px 24px', background:'hsl(0,0%,6%)' }}>
      <div style={{ maxWidth:'72rem', margin:'0 auto' }}>
        ...
        <div style={{ maxWidth:'42rem' }}>
          <p style={{ color:'hsl(0,0%,55%)', lineHeight:1.75, marginBottom:'20px' }}>{a.p1}</p>
          <p style={{ color:'hsl(0,0%,55%)', lineHeight:1.75, marginBottom:'20px' }}>{a.p2}</p>
          <p style={{ color:'hsl(0,0%,55%)', lineHeight:1.75, marginBottom:'32px' }}>{a.p3}</p>
