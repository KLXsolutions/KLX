    ...
    <footer className="border-t border-border py-10 px-6 md:px-8" style={{ background: '#050505' }}>
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
          <div>
            <div className="font-black text-base tracking-wider mb-2">
          ...
          <div>
            ...
            <div className="flex flex-col gap-1.5">
              {['#about', '#services', '#references', '#faq', '#contact'].map(href => (
                <a key={href} href={href} className="text-muted-foreground hover:text-primary transition-colors text-xs">
