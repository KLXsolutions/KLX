      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3.5 md:px-8">
        <a href="#home" className="flex items-center gap-3">
          <span className="font-black text-lg tracking-wider text-foreground">
            KLX <span className="text-primary">SOLUTIONS</span>
          </span>
        </a>
          ...
          <ul className="flex gap-7">
            {links.map(link => (
              <li key={link.href}>
                <a
                  href={link.href}
                  className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors relative group py-1.5"
                >
                  {link.label}
        ...
        <div className="lg:hidden border-t border-border bg-secondary">
          {links.map(link => (
            <a
              ...
              className="block px-8 py-3.5 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted transition-colors"
            >
              {link.label}
            </a>
          ))}
